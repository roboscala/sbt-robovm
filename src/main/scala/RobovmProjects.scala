...
<<<<<<< HEAD
        "org.robovm" % "robovm-rt" % "0.0.13",
        "org.robovm" % "robovm-objc" % "0.0.13",
        "org.robovm" % "robovm-cocoatouch" % "0.0.13",
        "org.robovm" % "robovm-cacerts-full" % "0.0.13"
=======
        "org.robovm" % "robovm-rt" % "0.0.12",
        "org.robovm" % "robovm-objc" % "0.0.12",
        "org.robovm" % "robovm-cocoatouch" % "0.0.12",
        "org.robovm" % "robovm-cacerts-full" % "0.0.12"
>>>>>>> roboscala/master
      ),
