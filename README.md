...
First, add the plugin to your project by appending `addSbtPlugin("org.roboscala" % "sbt-robovm" % "1.9.0")`
...
```scala
// Necessary only when testing with RoboVM snapshot build, such as 1.9.1-SNAPSHOT
resolvers += Resolver.sonatypeRepo("snapshots")

addSbtPlugin("org.roboscala" % "sbt-robovm" % "1.9.0-YOUR_SUFFIX" changing())
```
